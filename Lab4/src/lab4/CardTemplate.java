...
public interface CardTemplate {
	...
	// hollow diamonds and solid clubs, respectively. Try commenting it out if
	// you're on a Linux or Mac
	// to see what happens? If you see gibberish, use the other suitShort definition
	// below.
	// static char[] suitShort = new char[]{'\u2660', '\u2661', '\u2662', '\u2663'};

	// Windows console does not render unicode characters. Use the below line for
	// all
	...
	// Method to return the "short name" of the card, drawn from the various Short
	// arrays:
	// ie: "Ac" for "Ace of Clubs".
	public String getShortName();

	// Method to return the full name of the card, drawn from the various Long
	// arrays:
	// ie: "Ace of Clubs"
